...
app.post("/create", async (req, res) => {
    const { firstname , lastname , id_card , email, password 
        ...
        , country , nationality , tel , fax} = req.body;

    try {
        connection.query(
            "INSERT INTO users(firstname , lastname , id_card , email, password , address , sub_district , district , province , postal_code , country , nationality , tel , fax) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
            [firstname , lastname , id_card , email, password 
                , address , sub_district , district , province , postal_code 
                , country , nationality , tel , fax],
            (err, results, fields) => {
                if (err) {
